          ...
          >
            {!isLogin && (
              <div className="space-y-2">
                <Input name="fullName" placeholder="Full Name" required className="bg-[#F7F7F9] border border-[#DBDCDE] rounded-lg shadow-sm px-6 py-3 h-auto text-base placeholder:text-gray-400"/>
              </div>
            )}
